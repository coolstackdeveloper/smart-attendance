<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ShiftExceptionTypeSetup.aspx.cs" Inherits="UI.ShiftExceptionTypeSetup" %>
                ...
                <div>
                    <telerik:RadGrid ID="m_dgvGrid" 
                        ...
                        <MasterTableView TableLayout="Fixed"  runat="server" 
                            ...
                            <CommandItemSettings AddNewRecordText="Add Shift Exception Type" />
