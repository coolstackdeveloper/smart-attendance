<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DesignationSetup.aspx.cs" Inherits="UI.DesignationSetup" %>
                ...
                <div>
                    <telerik:RadGrid ID="m_dgvGrid" 
                        ...
                        <MasterTableView TableLayout="Fixed"  runat="server" 
                            ...
                            <CommandItemSettings AddNewRecordText="Add Designation" />
