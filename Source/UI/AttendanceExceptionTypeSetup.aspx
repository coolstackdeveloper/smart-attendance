<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AttendanceExceptionTypeSetup.aspx.cs" Inherits="UI.AttendanceExceptionTypeSetup" %>
                ...
                <div>
                    <telerik:RadGrid ID="m_dgvGrid" 
                        ...
                        <MasterTableView TableLayout="Fixed"  runat="server" 
                            ...
                            <CommandItemSettings AddNewRecordText="Add Entry Type" />
