<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProfileFieldSetup.aspx.cs" Inherits="UI.ProfileFieldSetup" %>
                ...
                <div>
                    <telerik:RadGrid ID="m_dgvGrid" 
                        ...
                        <MasterTableView TableLayout="Fixed"  runat="server" 
                            ...
                            <CommandItemSettings AddNewRecordText="Add Contact Field" />
